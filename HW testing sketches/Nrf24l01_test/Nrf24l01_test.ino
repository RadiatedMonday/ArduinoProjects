/*
 * программа выводит на последовательный порт информацию о модуле nRF24L01+ или радиомодуле nRF24L01+pa+lna Arduino;
 * далее выводится информация о всех частотах на которых работает модуль и информацию об их загруженности
 */
